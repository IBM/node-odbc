...
class Connection {
  ...
  get connected() {
    return this.odbcConnection.isConnected;
  }
   ...
   */
  callProcedure(name, callback = undefined) {
    // type-checking
    ...
    if (callback === undefined) {
      return new Promise((resolve, reject) => {
        this.odbcConnection.callProcedure('MARK.MAXBAL', [], (error, result) => {
          if (error) {
    ...
    // ...or callback
    return this.odbcConnection.callProcedure('MARK.MAXBAL', [1], callback);
  }
